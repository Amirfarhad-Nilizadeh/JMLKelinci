...
{   
    ...
    long /*@ pure @*/ Perimeter(int x, int y)
    {
    ...
    long /*@ pure @*/ Perimeter(int x, int y, int z)
    {
    ...
    long /*@ pure @*/ Perimeter(int w, int x, int y, int z)
    {
