    ...
    public class ExtractDriver {  
	 private static String address ="/Path to the jml directory that checks GCD preconditions/GCD/jml"; 
		...
		System.out.println("precondition : " + precondition + " Number1 is : " + num1 + " Number2 is : " + num2); 
		if (precondition) {
			GCD g = new GCD();
