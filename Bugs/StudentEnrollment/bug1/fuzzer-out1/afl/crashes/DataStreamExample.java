    ...
    public class DataStreamExample { 
         private static String address ="/home/amirfarhad/Desktop/ProgramAnalysis/codes/Kelinci/JMLKelinci/firstNonTrivial/StudentEnrollment/bug1/jml"; 
         public static void main(String args[]) {   
		int costPerCredit = 200;  
  		int totalCredits = 120;
 		int maxSemesterCredits = 20; 
              try{    
                FileInputStream fis=new FileInputStream("id:000000,sig:06,src:000000,op:havoc,rep:128");    
		...
		System.out.println("driverArg : " + driverArg);
