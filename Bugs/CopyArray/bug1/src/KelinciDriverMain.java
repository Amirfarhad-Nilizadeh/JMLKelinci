     ...
     private static String address ="/home/amirfarhad/Desktop/ProgramAnalysis/codes/Kelinci/JMLKelinci/firstNonTrivial/CopyArray/bug1/jml";	 
     public static void main(String args[]) {
		...
		String arrLength1 = String.valueOf(array1.length);
		String arrLength2 = String.valueOf(array2.length);

		String _iBegin = String.valueOf(iBegin);
		String _iEnd = String.valueOf(iEnd);
	     
		String[] strs = new String[array1.length];	
		String arrArg1 = "";

        	for (int i = 0; i < array1.length; i++) {
            		strs[i] = String.valueOf(array1[i]);
       		}
		...
		String[] _strs = new String[array2.length];	
		String arrArg2 = "";

        	for (int i = 0; i < array2.length; i++) {
            		_strs[i] = String.valueOf(array2[i]);
       		}
